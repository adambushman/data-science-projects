...
zoo <- read.csv(here::here("decision-tree", "classification", "zoo-animal-classes", "zoo.csv"))
class <- read.csv(here::here("decision-tree", "classification", "zoo-animal-classes", "class.csv"))
